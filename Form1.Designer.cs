...
namespace taiga
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
        	...
        	this.toolTip1.SetToolTip(this.pictureBox2, "Clique-me!");
        	...
        	this.label2.Location = new System.Drawing.Point(579, 7);
        	...
        	this.Text = "taiga ~wishes come true";
        	this.TopMost = true;
